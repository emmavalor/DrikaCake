...
flip_card.addEventListener('click', function(){
    ...
    photo1.style.backgroundPosition = "35%";
...
flip_card3.addEventListener('click', function(){
    ...
    photo1.style.backgroundSize = "cover";
    photo1.style.backgroundPosition = "top";
    photo2.style.backgroundImage = "url('image/sucette_meringue2.jpeg')";
    photo2.style.backgroundSize = "cover";
    photo2.style.backgroundPosition = "top";
...
flip_card4.addEventListener('click', function(){
    ...
    photo1.style.backgroundSize = "cover";
    photo1.style.backgroundPosition = "top";
    photo2.style.backgroundImage = "url('image/sable3.jpeg')";
    photo2.style.backgroundSize = "cover";
    photo2.style.backgroundPosition = "top";
    photo3.style.backgroundImage = "url('image/sable5.jpeg')";
    photo3.style.backgroundSize = "cover";
    photo3.style.backgroundPosition = "top";
});
...
flip_card5.addEventListener('click', function(){
    ...
    description.innerHTML = "Friandises typiques du brésil, ces truffes font le régal des petits et des grands. Plusieurs parfums sont proposés : <br/> - Le classique Brigadeiro 100% chocolat fait avec un chocolat 70% cacao, <br/>- Beijinho de coco 100% coco, fait avec de la noix de coco fraîche, <br/>- Cajuzinho, fait à la base de cacahuète, Olho de sogra, fait à la base de noix de coco et pruneau.";
    tarif.innerHTML = "1€ la pièce (Commande à la douzaine, 12,24,36…) <br> Pérsonnalisation spécifique + 1€";
    parfum.style.display = 'none';
    parfum_taste.innerHTML = 'dans la description';
    photo1.style.backgroundImage = "url('image/truffes2.jpeg')";
    photo1.style.backgroundSize = "cover";
    photo1.style.backgroundPosition = "top";
    photo2.style.backgroundImage = "url('image/truffes3.jpeg')";
    photo2.style.backgroundSize = "cover";
    photo2.style.backgroundPosition = "top";
